/* Generated by Cython 0.12.1 on Fri May 14 08:28:34 2010 */
...
/* "/usr/local/src/methylcode/code/cbowtie.pyx":7
 * 
 * 
...
static PyObject *__pyx_pf_7cbowtie__update_conversions(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/usr/local/src/methylcode/code/cbowtie.pyx":21
 *     cdef char a, b
 *     # CT, GA
 ...
 */
  ...
  /* "/usr/local/src/methylcode/code/cbowtie.pyx":22
 *     # CT, GA
 *     cdef char c1 = pair[0], c2 = pair[1]
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         # if genome is a T and read is a C
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "/usr/local/src/methylcode/code/cbowtie.pyx":26
 *         # bowtie couldnt find this cause we
 *         # converted C to T.
 ...
 */
    __pyx_t_3 = ((__pyx_v_ref_seq[__pyx_v_i]) != __pyx_v_c2);
    if (__pyx_t_3) {
    ...
    /* "/usr/local/src/methylcode/code/cbowtie.pyx":27
 *         # converted C to T.
 *         if ref_seq[i] != c2: continue
 *         if aln_seq[i] == c1:             # <<<<<<<<<<<<<<
 *             if allowed_mismatches == 0: return 1
 ...
 */
    __pyx_t_3 = ((__pyx_v_aln_seq[__pyx_v_i]) == __pyx_v_c1);
    if (__pyx_t_3) {

      /* "/usr/local/src/methylcode/code/cbowtie.pyx":28
 *         if ref_seq[i] != c2: continue
 *         if aln_seq[i] == c1:
 *             if allowed_mismatches == 0: return 1             # <<<<<<<<<<<<<<
 *             allowed_mismatches -= 1
 *     if allowed_mismatches < 0: return 1
 */
      __pyx_t_3 = (__pyx_v_allowed_mismatches == 0);
      if (__pyx_t_3) {
      ...
      /* "/usr/local/src/methylcode/code/cbowtie.pyx":29
 *         if aln_seq[i] == c1:
 *             if allowed_mismatches == 0: return 1
 *             allowed_mismatches -= 1             # <<<<<<<<<<<<<<
 *     if allowed_mismatches < 0: return 1
 ...
 */
  ...
  /* "/usr/local/src/methylcode/code/cbowtie.pyx":30
 *             if allowed_mismatches == 0: return 1
 *             allowed_mismatches -= 1
 *     if allowed_mismatches < 0: return 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/usr/local/src/methylcode/code/cbowtie.pyx":41
 *     """
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         a = ref_seq[i]
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "/usr/local/src/methylcode/code/cbowtie.pyx":42
 * 
 *     for i in range(n):
 *         a = ref_seq[i]             # <<<<<<<<<<<<<<
 *         if a != c1: continue
 ...
 */
    ...
    /* "/usr/local/src/methylcode/code/cbowtie.pyx":43
 *     for i in range(n):
 *         a = ref_seq[i]
 *         if a != c1: continue             # <<<<<<<<<<<<<<
 *         b = aln_seq[i]
 *         # CC
 */
    __pyx_t_3 = (__pyx_v_a != __pyx_v_c1);
    if (__pyx_t_3) {
    ...
    /* "/usr/local/src/methylcode/code/cbowtie.pyx":44
 *         a = ref_seq[i]
 *         if a != c1: continue
 *         b = aln_seq[i]             # <<<<<<<<<<<<<<
 *         # CC
 ...
 */
    ...
    /* "/usr/local/src/methylcode/code/cbowtie.pyx":46
 *         b = aln_seq[i]
 *         # CC
 *         if b == c1:             # <<<<<<<<<<<<<<
 ...
 *             #d[i] = chr(c1); ccs += 1
 */
    __pyx_t_3 = (__pyx_v_b == __pyx_v_c1);
    if (__pyx_t_3) {

      /* "/usr/local/src/methylcode/code/cbowtie.pyx":47
 *         # CC
 *         if b == c1:
 *             c_count[base_position + i] += 1             # <<<<<<<<<<<<<<
 *             #d[i] = chr(c1); ccs += 1
 ...
 */
    ...
    /* "/usr/local/src/methylcode/code/cbowtie.pyx":50
 *             #d[i] = chr(c1); ccs += 1
 *         # CT
 *         elif b == c2:             # <<<<<<<<<<<<<<
 ...
 *     """
 */
    __pyx_t_3 = (__pyx_v_b == __pyx_v_c2);
    if (__pyx_t_3) {

      /* "/usr/local/src/methylcode/code/cbowtie.pyx":51
 *         # CT
 *         elif b == c2:
 *             t_count[base_position + i] += 1             # <<<<<<<<<<<<<<
 *     """
 ...
 */
  ...
  /* "/usr/local/src/methylcode/code/cbowtie.pyx":58
...
#endif
{
  ...
  /* "/usr/local/src/methylcode/code/cbowtie.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport stdlib
 */
  ...
  /* "/usr/local/src/methylcode/code/cbowtie.pyx":4
 * cimport numpy as np
 * cimport stdlib
 * import sys             # <<<<<<<<<<<<<<
 * 
